...
% -------------------------------------------------------
% EXAMPLE 2
% extract 'rh.G_front_middle' of the rigth hemisphere

% find the atlas index of the area
area_idx=find(strcmpi(snames,'rh.G_front_middle'));
...
title('rh.G_front_middle');

% get some key results for the 'rh.G_front_middle' area
disp(' ')
disp('rh.G_front_middle')
mesh_get_fieldpeaks_and_focality(m_ROI,'field_idx',1);
mesh_show_surface(m_ROI);
